System.register(['aurelia-dependency-injection', 'aurelia-templating', '../common/widget-base', '../common/decorators', '../common/constants', '../common/options-builder', 'kendo.grid.min'], function (_export) {
  'use strict';

  var inject, customElement, bindable, children, ViewResources, WidgetBase, generateBindables, constants, OptionsBuilder, Grid;
  ...
  return {
    ...
    execute: function () {
      Grid = (function () {
        ...
        var _Grid = Grid;
        Grid = inject(Element, WidgetBase, ViewResources, OptionsBuilder)(Grid) || Grid;
